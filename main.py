...
def main():
    ...
    camera_ponto_objreader = Point(0, -15, 5)
    ...
    Fonte2 = Light(luzFonte_posicao, [0, 0, 0], [0.5, 0.5, 0.5], [0.6, 0.6, 0.6])
    FontesDeLuz = [Fonte1]
    # luz = Light(luz_posicao, [0,0.0,0.8], [0,0.0,0.3], [0,0.0,0.6])  # Luz vermelha

    camera = Cam(camera_ponto, alvo_ponto, u_new, 1, 500, 500)
    new_camera = Cam(camera_ponto_objreader, alvo_ponto, up_vector, 1, 700, 700)
    #plano = Plane(Point(-200, 0, 0), Vector(1, 0, 1), [0, 0, 255], kdCoefficient= 0.8, ksCoefficient= 0.8, kaCoefficient= 0.3, krCoefficient = 0.5, ktCoefficient = 0.5, irCoefficient = 1.52, nCoefficient= 500)
    plano = Plane(Point(0, 30, 0), Vector(1, -0.3, -1), [255, 255, 255], kdCoefficient= 0.8, ksCoefficient= 0.8, kaCoefficient= 0.3, krCoefficient = 0.5, ktCoefficient = 0.5, irCoefficient = 1.52, nCoefficient= 500)
    esfera =  Sphere(center, radius=50, color=[0, 255, 0],kdCoefficient= 0.8, ksCoefficient= 0.8, kaCoefficient= 0.3, krCoefficient = 0.5, ktCoefficient = 0.5, irCoefficient = 1.0, nCoefficient= 500)
    esfera2 =  Sphere(n_center, radius=50, color=[255, 150, 100],kdCoefficient= 0.8, ksCoefficient= 0.8, kaCoefficient= 0.3, krCoefficient = 0.5, ktCoefficient = 0.5, irCoefficient = 1.0, nCoefficient= 500)
    esfera3 =  Sphere(n_center2, radius=50, color=[0, 100, 255],kdCoefficient= 0.8, ksCoefficient= 0.8, kaCoefficient= 0.3, krCoefficient = 0.5, ktCoefficient = 0.5, irCoefficient = 1.0, nCoefficient= 500)
    ...
    malha = Mesh(
        ...
        [],
        [[100, 0, 200], [255, 0, 0], [0, 255, 0], [0, 0, 255], [120, 255, 200]],kdCoefficient= 0.8, ksCoefficient= 0.8, kaCoefficient= 0.3, krCoefficient = 0.5, ktCoefficient = 0.4, irCoefficient = 1.2, nCoefficient= 500
    )
    ...
    corFaces = corFaces = [[255, 0, 0] for face in obj.get_faces()]
    malha2 = Mesh(
        len(faces), 
        len(vertices), 
        vertices, 
        ...
        normais,
        [],
        corFaces,kdCoefficient= 0.8, ksCoefficient= 0.8, kaCoefficient= 0.3,krCoefficient = 0, ktCoefficient = 0, irCoefficient = 1.2, nCoefficient= 500)
   
    objects = [ plano, esfera]
    camera.raycasting(objects, luzAmbiente, FontesDeLuz)
    #new_camera.raycasting(objects, luzAmbiente, FontesDeLuz)
