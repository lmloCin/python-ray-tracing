...
def main():
    camera_ponto = Point(150, 100, 200)
    alvo_ponto = Point(0, 30, 0)
    ...
    plano = Plane(Point(0, -10, 0), Vector(0, 1, 0), [0, 0, 255], kdCoefficient= 0.9, ksCoefficient= 0.2, kaCoefficient= 0.3, krCoefficient = 0.5, ktCoefficient = 0.5, irCoefficient = 1.52, nCoefficient= 500)
    esfera =  Sphere(Point(0, 0, 0), radius=30, color=[0, 150, 0],kdCoefficient= 0.9, ksCoefficient= 0.4, kaCoefficient= 0.3, krCoefficient = 0.5, ktCoefficient = 0.5, irCoefficient = 1.52, nCoefficient= 500)
    esfera2 =  Sphere(Point(0, 70, 0), radius=30, color=[0, 150, 0],kdCoefficient= 0.9, ksCoefficient= 0.4, kaCoefficient= 0.3, krCoefficient = 0.5, ktCoefficient = 0.5, irCoefficient = 1.52, nCoefficient= 500)
    ...
    malha = Mesh(
        ...
        [],
        [[100, 0, 200], [255, 0, 0], [0, 255, 0], [0, 0, 255], [120, 255, 200]],kdCoefficient= 0.9, ksCoefficient= 0.9, kaCoefficient= 0.3, krCoefficient = 0.1, ktCoefficient = 0.4, irCoefficient = 1.2, nCoefficient= 500
    )
   

    objects = [malha, esfera, esfera2, plano]
