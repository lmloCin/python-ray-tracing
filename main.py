...
def main():
    ...
    luzFonte_posicao = Point(100, 100, 200)
    luzAmbiente = Light(luz_posicao, [255, 255, 255], [0.3,0.3,0.3,], [0.6, 0.6, 0.6])  # Luz branca
    Fonte1 = Light(luzFonte_posicao, [200, 200, 200], [0.3,0.3,0.3,], [0.6, 0.6, 0.6])
    FontesDeLuz = [Fonte1]
    ...
    plano = Plane(Point(0, 30, 0), Vector(1, -0.3, -1), [255, 255, 255], kdCoefficient= 0.8, ksCoefficient= 0.8, kaCoefficient= 0.3, krCoefficient = 0.5, ktCoefficient = 0.5, irCoefficient = 1.2, nCoefficient= 500)
    esfera =  Sphere(center, radius=50, color=[0, 150, 100],kdCoefficient= 0.8, ksCoefficient= 0.8, kaCoefficient= 0.3, krCoefficient = 0.2, ktCoefficient = 0.3, irCoefficient = 1.2, nCoefficient= 500)
    esfera2 =  Sphere(n_center, radius=50, color=[255, 150, 100],kdCoefficient= 0.8, ksCoefficient= 0.8, kaCoefficient= 0.3, krCoefficient = 0, ktCoefficient = 0.2, irCoefficient = 1.2, nCoefficient= 500)
